...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
  ...
  <div style="border: 1px solid #7c4dff; padding: 15px; border-radius: 8px;">
    <h4 style="color: #7c4dff;">📜 Proxmox</h4>
    <ul>
      <li><a href="/proxmox/">Scripts d'Automatisation Bash</a></li>
      <li><a href="/proxmox/">Gestion des tâches Cron</a></li>
    </ul>
  </div>
  <div style="border: 1px solid #7c4dff; padding: 15px; border-radius: 8px;">
    <h4 style="color: #7c4dff;">📜 VM</h4>
    <ul>
      <li><a href="/vms/vm-managements">Gestion des VM</a></li>
      <li><a href="/vms/"></a></li>
    </ul>
  </div>
</div>
